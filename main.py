...
class Console():        
    def ui(self):
        os.system(f'cls && title [Boo] Discord Nitro Generator  ^|  For Help join discord.gg/rpYPUuWVGB' if os.name == "nt" else "clear")
        print(center(f"""\n\n
  ___         ___  
 (o o)       (o o) 
(  V  ) Boo (  V  )
--m-m---------m-m--            ~ Discord Nitro Generator ~
    
                                   github.com/rpYPUuWVGB Web ~ booislive.tk
\n\n
